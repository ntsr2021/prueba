...
// Verificar si hai un banner a la derecha del que se desea mover 
$sql = "SELECT * FROM banner_marca WHERE posicion=($posicion+1)";
$cons = $conex->query($sql);


$mens = '';
if($cons->fetch_array()) // Si hai un banner a la derecha 
{
	// Mover a la izquierda el banner de la derecha
